...
pub trait LatexEnvironment {
    /// Writes the name of the [LaTeX] [environment] to the given destination that implements the [`Write`] trait.
    /// 
    /// # Arguments
    /// 
    ...
    /// `W` - type argument of the destination, expected to implement the [`Write`] trait.
    /// 
    /// `dest` - destination to write the opening tag of the [LaTeX] [environment] to.
    /// 
    /// # Returns
    /// 
    ...
    /// `W` - type argument of the destination, expected to implement the [`Write`] trait.
    /// 
    /// `dest` - destination to write the closing tag of the [LaTeX] [environment] to.
    /// 
    /// # Returns
    /// 
